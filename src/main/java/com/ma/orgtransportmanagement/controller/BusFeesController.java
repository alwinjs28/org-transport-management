...
public class BusFeesController {
        ...
        @RequestMapping(value = "g_bus_fees/{bus_type_id}",method = RequestMethod.GET)
        @ResponseBody
        public BusFeesDto getBusFees(@PathVariable("bus_type_id")Long busTypeId){
            return busFeesService.getBusFees(busTypeId);
        }
